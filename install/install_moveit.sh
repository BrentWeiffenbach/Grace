...
sudo apt-get install ros-melodic-pybind11-catkin ros-melodic-eigen-stl-containers ros-melodic-random-numbers ros-melodic-shape-msgs ros-melodic-object-recognition-msgs ros-melodic-graph-msgs ros-melodic-ruckig sudo apt install ros-melodic-eigenpy
