...
"""A list of the valid states in msg/RobotState.msg. 

This is achieved by getting all the non-callable ints and float constants from the autogenerated python file. 
"""
